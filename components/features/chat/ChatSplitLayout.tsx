  ...
  return (
    <>
        ...
        <div className="w-[360px] shrink-0 flex flex-col h-full border-r border-gray-200 bg-white">
          ...
          <div className="flex items-center justify-between px-3 pt-5 pb-3 border-b border-gray-100">
            ...
            >
              <svg className="w-5 h-5 text-slate-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
                ...
                <path d="M17.586 3.414a2 2 0 1 1 2.828 2.828L12 14.828l-4 1 1-4 8.586-8.414z" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
          </div>
          ...
          <div className="px-4 py-2.5 border-b border-gray-100">
            <div className="flex items-center gap-2 bg-gray-100 rounded-full px-3.5 py-2">
              ...
              <span className="text-sm text-gray-400 select-none">검색</span>
            </div>
          </div>

          {/* 방 목록 — 스크롤 격리 */}
          <div className="flex-1 overflow-y-auto no-scrollbar">
            <DesktopRoomList rooms={rooms} currentUserId={currentUserId} activeRoomId={activeRoomId} />
          </div>
        </div>
      ...
      <div className="md:hidden">
        {isRootPage
          ? <ChatList rooms={rooms} currentUserId={currentUserId} />
          : children
        }
      </div>
    </>
